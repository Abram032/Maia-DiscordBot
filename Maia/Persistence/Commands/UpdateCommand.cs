...
namespace Maia.Persistence.Commands
{
    class UpdateCommand : ICommand
    {
        ...
        public UpdateCommand(List<string> parameters, IUser author, IMessageChannel channel, IConfiguration config, IMessageWriter messageWriter, IConnectionHandler connectionHandler)
        {
