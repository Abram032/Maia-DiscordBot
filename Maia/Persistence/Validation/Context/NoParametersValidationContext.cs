...
{
    class NoParametersValidationContext : BaseCommandValidationContext, ICommandValidationContext
    {
        public NoParametersValidationContext(IConfiguration config) : base(config)
        {
        }
        ...
        public override IEnumerable<ValidationResult> Validate(BaseCommand command)
        {
            ...
            var parametersValidator = new NoParametersValidator(_config);
